...
const (
	Hello_Say_FullMethodName = "/api.v1.benchmark.Hello/Say"
)
...
func (c *helloClient) Say(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloReq, error) {
	out := new(HelloReq)
...
func (UnimplementedHelloServer) Say(context.Context, *HelloReq) (*HelloReq, error) {
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "servers/asjard/protobuf/hello.proto",
}
